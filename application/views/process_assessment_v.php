            ...
            <div class="col-5">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <p>
                    <img id="prev_img" src="<?= base_url('uploads/item/' . $subs['item_pict']) ?>" style="max-width: 180px; max-height:180px; border: 2px solid lightgrey;  padding: 1rem;   border-radius: 7px;">
                </div>
              </div>
            </div>
          </div>
